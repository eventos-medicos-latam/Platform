-- Varias entradas por persona: se reutiliza un pago en espera;
-- si ya hay una inscripción confirmada, se crea otra.

alter table event_registrations
  drop constraint if exists event_registrations_person_id_event_id_key;
