...
export function AllyPlanRequestDrawer({
  open,
  onClose,
  editionId,
  editionName,
  ...
  const stepDots: FormStep[] = ['search', 'email', 'empresa', 'contacto'];
              ...
              <div className="flex items-start justify-between px-6 py-4">
                <div className="min-w-0 pr-3">
                  <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-accent">
                    {planId ? `${editionName} · Plan ${planId}` : 'Registro de empresa aliada'}
                  </p>
                    ...
                    <div className="w-full rounded-2xl border border-line bg-canvas">
                      ...
                      <div className="space-y-2.5 px-5 py-4">
                        <div className="flex justify-between gap-3 text-sm">
                          ...
                          <span className="text-right font-semibold text-brand">{editionName}</span>
                        </div>
                        {planId && (
                          <div className="flex justify-between gap-3 text-sm">
